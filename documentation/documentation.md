...
API目录：
- [TigoWeb](#user-content-TigoWeb)
  - [type BaseHandler](#user-content-BaseHandler)
    - [func InitHandler](#user-content-InitHandler)
    - [func GetJsonValue](#user-content-GetJsonValue)
    - [func GetParameter](#user-content-GetParameter)
    - [func GetHeader](#user-content-GetHeader)
    - [func SetHeader](#user-content-SetHeader)
    - [func GetCookie](#user-content-GetCookie)
    - [func SetCookie](#user-content-SetCookie)
    - [func GetSecureCookie](#user-content-GetSecureCookie)
    - [func SetSecureCookie](#user-content-SetSecureCookie)
    - [func GetCookieObject](#user-content-GetCookieObject)
    - [func SetCookieObject](#user-content-SetCookieObject)
    - [func ClearCookie](#user-content-ClearCookie)
    - [func ClearAllCookie](#user-content-ClearAllCookie)
    - [func Redirect](#user-content-Redirect)
    - [func RedirectPermanently](#user-content-RedirectPermanently)
    - [func Render](#user-content-Render)
    - [func ResponseAsHtml](#user-content-ResponseAsHtml)
    - [func ResponseAsText](#user-content-ResponseAsText)
    - [func ResponseAsJson](#user-content-ResponseAsJson)
    - [func ToJson](#user-content-ToJson)
    - [func DumpHttpRequestMsg](#user-content-DumpHttpRequestMsg)
  - [type UrlPattern](#user-content-UrlPattern)
    - [func AppendUrlPattern](#user-content-AppendUrlPattern)
    - [func Init](#user-content-Init)
  - [type Application](#user-content-Application)
    - [func Run](#user-content-Run)
  - [type Cookie](#user-content-Cookie)
    - [func GetCookieEncodeValue](#user-content-GetCookieEncodeValue)
    - [func GetCookieDecodeValue](#user-content-GetCookieDecodeValue)
    - [func ToHttpCookie](#user-content-ToHttpCookie)
    - [func ConvertFromHttpCookie](#user-content-ConvertFromHttpCookie)
    - [func SetSecurityKey](#user-content-SetSecurityKey)
  - [type BaseResponse](#user-content-BaseResponse)
    - [func Print](#user-content-Print)
  ...
  - [utils](#user-content-utils)
    ...
    - [func InitGlobalConfig](#user-content-InitGlobalConfig)
- [logger](#user-content-logger)
  - [Demo](#user-content-logDemo)
  - [structure](#user-content-LogStructure)
    - [type LogLevel](#user-content-LogLevel)
  - [functions](#user-content-loggerFunctions)
    - [func SetLogPath](#user-content-SetLogPath)
    - [func InitLoggerWithConfigFile](#user-content-InitLoggerWithConfigFile)
    - [func InitLoggerWithObject](#user-content-InitLoggerWithObject)
    - [func InitTrace](#user-content-InitTrace)
    - [func InitInfo](#user-content-InitInfo)
    - [func InitWarning](#user-content-InitWarning)
    - [func InitError](#user-content-InitError)
